...
class Service:
    ...
    def can_add_to_service_queue(self, car: Car) -> bool:
        ...
        for service_car in self.cars_in_service:
            if service_car.color == car.color and service_car.make == car.make:
                return False
    ...
    def repair(self) -> Car:
        ...
        repaired_car = self.cars_in_service.pop(0)
        return repaired_car
    ...
    def get_the_car_with_the_biggest_engine(self) -> list:
        ...
        cars_with_biggest_engine = [
            car for car in self.cars_in_service if car.engine_size == max_engine_size
        ]

        return cars_with_biggest_engine
