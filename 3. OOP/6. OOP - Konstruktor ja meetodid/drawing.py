...
class DrawingFullError(Exception):
    """Exception raised when drawing canvas is full."""


class FigureDoesNotExistError(Exception):
    """Exception raised when a figure does not exist on the drawing."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(
            dc.figures
        )  # -> Empty data structure (it depends on which one you have chose)
    ...
    print(
        dc.figures
    )  # -> Data structure containing 1 circle, 1 triangle and 1 Mona Lisa
